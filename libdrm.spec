...
Version  : 2.4.90
Release  : 48
URL      : https://dri.freedesktop.org/libdrm/libdrm-2.4.90.tar.gz
Source0  : https://dri.freedesktop.org/libdrm/libdrm-2.4.90.tar.gz
Source99 : https://dri.freedesktop.org/libdrm/libdrm-2.4.90.tar.gz.sig
...
%prep
%setup -q -n libdrm-2.4.90
pushd ..
cp -a libdrm-2.4.90 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1518851502
export AR=gcc-ar
