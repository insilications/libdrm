...
Source0  : https://dri.freedesktop.org/libdrm/libdrm-2.4.83.tar.gz
Source99 : https://dri.freedesktop.org/libdrm/libdrm-2.4.83.tar.gz.sig
...
%prep
%setup -q -n libdrm-2.4.83
pushd ..
cp -a libdrm-2.4.83 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1503583694
export AR=gcc-ar
