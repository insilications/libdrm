...
#
# Source0 file verified with key 0x8CD1DF552975297B (robert@sixbynine.org)
#
Name     : libdrm
Version  : 2.4.74
Release  : 27
...
Source99 : http://dri.freedesktop.org/libdrm/libdrm-2.4.74.tar.gz.sig
...
%prep
%setup -q -n libdrm-2.4.74
pushd ..
cp -a libdrm-2.4.74 build32
popd

%build
export LANG=C
export SOURCE_DATE_EPOCH=1484495967
export AR=gcc-ar
