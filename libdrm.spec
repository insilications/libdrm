...
Version  : 2.4.93
Release  : 55
URL      : https://dri.freedesktop.org/libdrm/libdrm-2.4.93.tar.gz
Source0  : https://dri.freedesktop.org/libdrm/libdrm-2.4.93.tar.gz
Source99 : https://dri.freedesktop.org/libdrm/libdrm-2.4.93.tar.gz.sig
...
%prep
%setup -q -n libdrm-2.4.93
pushd ..
cp -a libdrm-2.4.93 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1533133262
export AR=gcc-ar
