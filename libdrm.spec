...
Version  : 2.4.87
Release  : 44
URL      : https://dri.freedesktop.org/libdrm/libdrm-2.4.87.tar.gz
Source0  : https://dri.freedesktop.org/libdrm/libdrm-2.4.87.tar.gz
Source99 : https://dri.freedesktop.org/libdrm/libdrm-2.4.87.tar.gz.sig
...
%prep
%setup -q -n libdrm-2.4.87
pushd ..
cp -a libdrm-2.4.87 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1509471588
export AR=gcc-ar
