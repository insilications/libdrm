...
Version  : 2.4.75
Release  : 28
URL      : http://dri.freedesktop.org/libdrm/libdrm-2.4.75.tar.gz
Source0  : http://dri.freedesktop.org/libdrm/libdrm-2.4.75.tar.gz
Source99 : http://dri.freedesktop.org/libdrm/libdrm-2.4.75.tar.gz.sig
...
%prep
%setup -q -n libdrm-2.4.75
pushd ..
cp -a libdrm-2.4.75 build32
popd

%build
export LANG=C
export SOURCE_DATE_EPOCH=1485618087
export AR=gcc-ar
