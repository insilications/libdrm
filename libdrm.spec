...
Version  : 2.4.77
Release  : 29
URL      : http://dri.freedesktop.org/libdrm/libdrm-2.4.77.tar.gz
Source0  : http://dri.freedesktop.org/libdrm/libdrm-2.4.77.tar.gz
Source99 : http://dri.freedesktop.org/libdrm/libdrm-2.4.77.tar.gz.sig
...
%prep
%setup -q -n libdrm-2.4.77
pushd ..
cp -a libdrm-2.4.77 build32
popd

%build
export LANG=C
export SOURCE_DATE_EPOCH=1491338680
export AR=gcc-ar
