...
Version  : 2.4.97
Release  : 61
URL      : https://dri.freedesktop.org/libdrm/libdrm-2.4.97.tar.gz
Source0  : https://dri.freedesktop.org/libdrm/libdrm-2.4.97.tar.gz
Source99 : https://dri.freedesktop.org/libdrm/libdrm-2.4.97.tar.gz.sig
...
%prep
%setup -q -n libdrm-2.4.97
%patch1 -p1
pushd ..
cp -a libdrm-2.4.97 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1548203087
export AR=gcc-ar
