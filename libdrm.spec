...
#
# Source0 file verified with key 0xCB703165A88984DC (tja@iki.fi)
#
Name     : libdrm
Version  : 2.4.101
Release  : 68
URL      : https://dri.freedesktop.org/libdrm/libdrm-2.4.101.tar.xz
Source0  : https://dri.freedesktop.org/libdrm/libdrm-2.4.101.tar.xz
Source1  : https://dri.freedesktop.org/libdrm/libdrm-2.4.101.tar.xz.sig
...
%prep
%setup -q -n libdrm-2.4.101
cd %{_builddir}/libdrm-2.4.101
%patch1 -p1
pushd ..
cp -a libdrm-2.4.101 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1587483131
