...
Source0  : http://dri.freedesktop.org/libdrm/libdrm-2.4.66.tar.gz
...
%prep
%setup -q -n libdrm-2.4.66

%build
export AR=gcc-ar
export RANLIB=gcc-ranlib
export CFLAGS="$CFLAGS -flto -O3 -ffunction-sections -fno-semantic-interposition "
export CXXFLAGS="$CXXFLAGS -flto -O3 -ffunction-sections -fno-semantic-interposition "
