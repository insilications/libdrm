...
Version  : 2.4.88
Release  : 45
URL      : https://dri.freedesktop.org/libdrm/libdrm-2.4.88.tar.gz
Source0  : https://dri.freedesktop.org/libdrm/libdrm-2.4.88.tar.gz
Source99 : https://dri.freedesktop.org/libdrm/libdrm-2.4.88.tar.gz.sig
...
%prep
%setup -q -n libdrm-2.4.88
pushd ..
cp -a libdrm-2.4.88 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1510233490
export AR=gcc-ar
